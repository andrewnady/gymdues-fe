...
export default function ListYourGymSetPasswordPage() {
      ...
      <div className='w-full max-w-md'>
        <div className='text-center mb-8'>
          ...
          <p className='text-muted-foreground mt-1 text-sm'>
            Set a password to secure your account, then we&apos;ll take you to the listing form.
          </p>
        </div>
