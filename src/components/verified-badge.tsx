...
export function VerifiedBadge({ gymName }: VerifiedBadgeProps) {
      ...
      {open && (
        ...
        >
          ...
          <button
            ...
            onClick={() => {
              setOpen(false)
              window.location.href = `mailto:support@gymdues.com?subject=Claim Dispute: ${encodeURIComponent(gymName)}`
            }}
